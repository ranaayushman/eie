  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-start p-4">
      ...
      <section className="w-full max-w-5xl mt-8 flex flex-col md:flex-row items-center shadow-lg rounded-lg overflow-hidden">
        ...
        <div className="p-6 md:w-1/2 flex flex-col items-start">
          ...
          <p className="text-gray-200 text-xl">
            The Instrument Society of India (ISOI) was established with the aim
            of promoting the growth and knowledge of instrumentation in India.
            It serves as a platform for professionals, students, and enthusiasts
            to collaborate and share advancements in the field of
            instrumentation.
          </p>
        </div>
      </section>
      ...
      <section className="w-full max-w-5xl mt-8  shadow-lg rounded-lg p-6 flex flex-col space-y-6">
        ...
        <p className="text-gray-200 text-xl">
          ISOI provides an excellent opportunity for engineers, scientists, and
          students to expand their knowledge and network with peers in the
        ...
        <p className="text-gray-200">
          ...
          showcase their skills and innovations in the field of instrumentation.
        </p>
      </section>
    </div>
  );
